...
export default function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    const TotalCost = getCookie('PLMOKN', { req, res });
    ...
    const { CartItems, Charges, TotalCost, TotalPrice, TotalQuantities } = req.body;

    setCookie('QAZWSX', JSON.stringify(CartItems), { req, res, maxAge: 60 * 60 * 24 * 7 });
    setCookie('PLMOKN', TotalCost.toString(), { req, res, maxAge: 60 * 60 * 24 * 7 });
